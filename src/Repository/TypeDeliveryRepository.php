...
class TypeDeliveryRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TypeDelivery $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TypeDelivery $entity, bool $flush = true): void
    {
